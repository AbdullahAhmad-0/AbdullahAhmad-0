		...
		<div className="flex flex-col h-full">
			...
			<div className="text-center mb-6">
				<div className="relative w-32 h-32 mx-auto mb-4">
					<div className="absolute inset-0 rounded-full bg-gradient-to-r from-violet-600 to-blue-500 animate-pulse z-10"></div>
					<img src={image} alt={personalInfo.name} className="w-28 h-28 object-cover rounded-full absolute inset-0 m-auto z-10" loading="lazy" />
				</div>
				<h1 className="text-2xl font-bold bg-gradient-to-r from-violet-400 to-blue-400 bg-clip-text text-transparent gradient-text">{personalInfo.name}</h1>
			...
			<div className="mb-6">
				...
				<div className="space-y-3">
					<div className="flex items-center justify-between group">
						<div className="flex items-center gap-2 hover:cursor-pointer" onClick={() => window.open(personalInfo.email_url, "_blank")}>
						...
						<div>
							<button
								onClick={() => window.open(personalInfo.email_url, "_blank")}
								className="mr-1 opacity-0 group-hover:opacity-100 transition-opacity text-xs px-2 py-1 bg-violet-700/30 hover:bg-violet-700/50 rounded"
							>
								Open
							</button>
							<button
					...
					<div className="flex items-center justify-between group">
						<div className="flex items-center gap-2 hover:cursor-pointer" onClick={() => window.open(personalInfo.phone_url, "_blank")}>
							<span className="text-violet-400">
								<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
									<path
										strokeLinecap="round"
						...
						<div>
							<button
								onClick={() => window.open(personalInfo.phone_url, "_blank")}
								className="mr-1 opacity-0 group-hover:opacity-100 transition-opacity text-xs px-2 py-1 bg-violet-700/30 hover:bg-violet-700/50 rounded"
							>
								Open
							</button>
					...
					<div className="flex items-center justify-between group">
						<div
							...
							onClick={() => window.open(personalInfo.whatsapp_url, "_blank")}
						>
							<span className="text-violet-400">
								<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
					...
					<div className="flex items-center justify-between group">
						<div className="flex items-center gap-2 hover:cursor-pointer" onClick={() => window.open(personalInfo.discord_url, "_blank")}>
							<span className="text-violet-400">
								<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						...
						<div>
							<button
								onClick={() => window.open(personalInfo.discord_url, "_blank")}
								className="mr-1 opacity-0 group-hover:opacity-100 transition-opacity text-xs px-2 py-1 bg-violet-700/30 hover:bg-violet-700/50 rounded"
							>
								Open
							</button>
