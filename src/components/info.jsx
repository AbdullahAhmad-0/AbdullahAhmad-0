...
const Info = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="text-center mb-6">
        <div className="relative w-32 h-32 mx-auto mb-4">
          ...
          <img
            ...
            className="w-28 h-28 object-cover rounded-full absolute inset-0 m-auto"
          />
        </div>
      ...
      {/* Contact info */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold mb-3 border-b border-violet-600/30 pb-1">
          Contact Information
        </h2>
